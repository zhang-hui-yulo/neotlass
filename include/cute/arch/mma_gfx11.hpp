...
using bfloat16_t_16 = unsigned short __attribute__((ext_vector_type(16)));
...
#else
        CUTE_INVALID_CONTROL_PATH("Attempting to use GFX11_16x16x16_F16F16F16F16_TIED_TN without CUTE_ARCH_MMA_GFX10_ENABLED");
#endif
    }
};
...
#else
        CUTE_INVALID_CONTROL_PATH("Attempting to use GFX11_16x16x16_BF16BF16BF16BF16_TIED_TN without CUTE_ARCH_MMA_GFX10_ENABLED");
#endif
    }
};
